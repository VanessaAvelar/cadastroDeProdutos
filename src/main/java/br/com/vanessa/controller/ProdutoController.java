package br.com.vanessa.controller;
...
import br.com.vanessa.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public List<Produto> listarProdutos() {
		...
		/*
		 * Produto p1 = new Produto("celular sansuga", 35, 1299.99); Produto p2 = new
	...
	public ResponseEntity<Produto> atualizarProduto(@PathVariable Long id, @RequestBody Produto produto) {
		return produtoRepository.findById(id).map(objetoGravado -> {
			objetoGravado.setNome(produto.getNome());
